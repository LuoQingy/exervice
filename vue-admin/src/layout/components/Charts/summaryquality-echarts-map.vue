...
<script>
  ...
  export default {
    ...
    mounted () {
      let list =  {
          "广东":{"总IP":14,"百分比":0.74,"独立IP":2},
          "河南":{"总IP":5,"百分比":0.26,"独立IP":1},
          "北京":{"总IP":14,"百分比":0.74,"独立IP":2},
          // "天津":{"总IP":5,"百分比":0.26,"独立IP":1},
          // "河北":{"总IP":14,"百分比":0.74,"独立IP":2},
          // "山西":{"总IP":5,"百分比":0.26,"独立IP":1},
          "内蒙古":{"总IP":14,"百分比":0.74,"独立IP":2},
          "黑龙江":{"总IP":5,"百分比":0.26,"独立IP":1},
        };
      this.initData(list)
    },
    beforeDestroy () {
      ...
      initData(dataList){
        if(dataList instanceof Object){
          ...
          for(let key in list){
            ...
            this.province.push({name:key,value:0})
            console.log(obj)
