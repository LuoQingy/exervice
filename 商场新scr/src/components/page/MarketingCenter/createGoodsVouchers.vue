    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px">
      <div class="basic-infor">
        ...
        <div class="addActivity-content fl">
          ...
          <el-form-item label="商品副标题：" prop="commoditySubtitile">
            <el-input style="width:340px;" maxlength="60" size="small" placeholder="请输入" v-model="ruleForm.commoditySubtitile"></el-input>
          </el-form-item>
          <el-form-item label="代金券面额：" prop="commodityOriginalPrice">
            <el-input
              style="width:150px;"
              maxlength="11"
              size="small"
          ...
          <el-form-item label="代金券售价：" prop="commodityPreferentialPrice">
            <el-input
              style="width:150px;"
              maxlength="11"
              size="small"
          ...
          <el-form-item label="代金券首图：" prop="firstPicture">
            <div>
      ...
      <div class="basic-infor">
        ...
        <div class="addActivity-content fl">
          ...
          <el-form-item label="核销限制：" prop="commodityVoucherRestrict">
...
export default {
  ...
  data() {
    return {
      ruleForm: {
        commodityId: 50, //类型：Number  必有字段  备注：无
    ...
    preservation(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          if(!this.value4Chang(this.value4)||!this.value3Chang(this.value3)){
              return ;
          }
          this.ruleForm.commodityImgList.push(objImg);
          if (!this.orContent || this.orContent == "<p><br></p>") {
            this.$message.warning("请输入使用须知");
            return;
          } else if (specailTest(this.orContent)) {
            this.$message.warning("使用须知内容不能包含特殊字符");
            return;
          } else {
