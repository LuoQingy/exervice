...
export default {
          ...
          if (this.checksize) {
            ...
            img.onload = function() {
              if (img.width == "60" && img.height == "60") {
                ...
                _this.$emit("childByValueOne", result.data.resp);
              } else {
                _this.$message({
            ...
            this.$emit("childByValueOne", result.data.resp);
          }
        }
      });
      return false;
  ...
  computed: {
    getFun() {
      ...
      if (this.ruleFormT.otherImageUrl != "") {
        this.imageUrl = this.ruleFormT.otherImageUrl;
      }
    }
  }
};
